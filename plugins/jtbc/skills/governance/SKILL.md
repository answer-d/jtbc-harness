...
|---|---|---|---|---|---|
| proposal | PROPOSAL | REQUIREMENTS | 提案書 | 課長, 部長, 社長 | 要 |
| project_plan | REQUIREMENTS | BASIC_DESIGN | 計画書, 要件定義書, リスク登録簿 | 課長, 部長, 主任 | 要 |
| basic_design | BASIC_DESIGN | DETAILED_DESIGN | 基本設計書, 課題管理簿 | 課長, 部長 | 要 |
| detailed_design | DETAILED_DESIGN | IMPLEMENTATION | 詳細設計書, WBS, テスト計画書 | 課長, 主任, 部長 | 要 |
...
|---|---|---|---|
| 提案内容・PJ計画 レビュー | 提案審査の前 | 提案書 | 課長(重要局面で部長同席) |
| 要件定義書 レビュー | PJ計画審査の前 | 要件定義書 | 課長 |
| 基本設計書 レビュー | 基本設計審査の前 | 基本設計書 | 課長 |
| 詳細設計書 レビュー | 詳細設計審査の前 | 詳細設計書 | 課長 |
